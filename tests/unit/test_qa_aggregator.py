...
def test_aggregate_all_checks_pass() -> None:
    ...
    result = aggregator.aggregate(
        ...
        coverage_result=qa_models.CoverageResult(success=True, coverage_pct=91.0, threshold_passed=True),
...
def test_aggregate_marks_failures_and_counts() -> None:
    ...
    result = aggregator.aggregate(
        ...
        coverage_result=qa_models.CoverageResult(success=True, coverage_pct=62.5, threshold_passed=False),
