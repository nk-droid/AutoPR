...
class PROpenRequest(BaseModel):
    ...
    head_repo: str | None = Field(default=None, description="Optional source repository name for cross-repository PRs within the same org.")
...
class PROpenOutput(BaseModel):
    request: PROpenRequest | None = Field(default=None, description="PR request payload used for open operation.")
    pull_request_number: int | None = Field(default=None, description="Opened pull request number if available.")
