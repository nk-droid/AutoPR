...
class ReviewOutput(BaseModel):
    ...
    required_actions: list[str] = Field(
        default_factory=list, description="Actions needed before merge can proceed."
    )
    llm_review: LLMMergeRiskReview | None = Field(
        default=None, description="Advisory LLM merge-risk review."
    )
